      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12">
          <div className="bg-white border-2 border-gray-200 rounded-2xl p-6 sm:p-8 text-center hover:-translate-y-2 hover:shadow-2xl hover:border-primary transition-all">
            ...
            <a href="mailto:info@freshbitescafe.com" className="inline-block px-4 sm:px-6 py-2 sm:py-3 text-white rounded-lg font-semibold hover:-translate-y-1 hover:shadow-xl transition-all text-sm sm:text-base" style={{backgroundColor: '#3D1E0B'}} onMouseEnter={(e) => e.target.style.backgroundColor = '#5C3215'} onMouseLeave={(e) => e.target.style.backgroundColor = '#3D1E0B'}>
          ...
          <div className="bg-white border-2 border-gray-200 rounded-2xl p-6 sm:p-8 text-center hover:-translate-y-2 hover:shadow-2xl hover:border-primary transition-all">
            ...
            <button onClick={handleCall} className="inline-block px-4 sm:px-6 py-2 sm:py-3 text-white rounded-lg font-semibold hover:-translate-y-1 hover:shadow-xl transition-all border-none cursor-pointer text-sm sm:text-base" style={{backgroundColor: '#3D1E0B'}} onMouseEnter={(e) => e.target.style.backgroundColor = '#5C3215'} onMouseLeave={(e) => e.target.style.backgroundColor = '#3D1E0B'}>
              Call Now
            </button>
          </div>
          ...
          <div className="bg-white border-2 border-gray-200 rounded-2xl p-6 sm:p-8 text-center hover:-translate-y-2 hover:shadow-2xl hover:border-primary transition-all">
            ...
            <a href="/my-orders" className="inline-block px-4 sm:px-6 py-2 sm:py-3 text-white rounded-lg font-semibold hover:-translate-y-1 hover:shadow-xl transition-all text-sm sm:text-base" style={{backgroundColor: '#3D1E0B'}} onMouseEnter={(e) => e.target.style.backgroundColor = '#5C3215'} onMouseLeave={(e) => e.target.style.backgroundColor = '#3D1E0B'}>
              Track Your Order
            </a>
          </div>
        </div>
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 sm:p-8 lg:p-12 text-center shadow-xl">
          ...
          <button onClick={handleCall} className="inline-flex items-center gap-2 sm:gap-3 px-6 py-3 sm:px-8 sm:py-4 text-white rounded-lg text-base sm:text-lg font-semibold hover:-translate-y-1 hover:shadow-2xl transition-all shadow-lg border-none cursor-pointer" style={{backgroundColor: '#3D1E0B'}} onMouseEnter={(e) => e.target.style.backgroundColor = '#5C3215'} onMouseLeave={(e) => e.target.style.backgroundColor = '#3D1E0B'}>
