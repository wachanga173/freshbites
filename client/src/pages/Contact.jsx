      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12">
          <div className="bg-white border-2 border-gray-200 rounded-2xl p-6 sm:p-8 text-center hover:-translate-y-2 hover:shadow-2xl hover:border-primary transition-all">
            ...
            <a href="mailto:info@freshbitescafe.com" className="inline-block px-4 sm:px-6 py-2 sm:py-3 text-white rounded-lg font-semibold hover:-translate-y-1 hover:shadow-xl transition-all text-sm sm:text-base" style={{backgroundColor: 'var(--color-primary)'}} onMouseEnter={(e) => e.target.style.backgroundColor = 'var(--color-primary-light)'} onMouseLeave={(e) => e.target.style.backgroundColor = 'var(--color-primary)'}>
